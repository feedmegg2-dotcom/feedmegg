      ...
      <div style={{ background: card, border: `1px solid ${border}`, borderRadius: '20px', padding: 'clamp(24px,5vw,40px)', width: '100%', maxWidth: '400px' }}>
        ...
        <div style={{ display: 'grid', gap: '10px', marginBottom: '20px' }}>
          ...
          <button onClick={() => handleSocialLogin('facebook')} disabled={!!socialLoading}
            style={{ width: '100%', padding: '12px', background: '#1877F2', border: 'none', borderRadius: '10px', color: '#ffffff', fontSize: '14px', fontWeight: 600, cursor: 'pointer', fontFamily: 'inherit', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px' }}>
